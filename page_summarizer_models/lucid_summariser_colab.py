...
Original file is located at
    https://colab.research.google.com/drive/1zO3wGzjwyMQkfjrJvPaomfOgBgzUdR3O
"""
#use only tensorflow 1.1.0
...
#before you unzip, you have to download number batch and place in either
#your local pc or on google drive
#this unzips the downloader number batch
!unzip "/content/drive/My Drive/lucid/numberbatch-en-19.08.zip"


#download reviews.csv from kaggle
